...
public class itemOtherActivity extends AppCompatActivity {

    private Other toDisplay;
    private int item_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        toDisplay = (Other) getIntent().getSerializableExtra("other");
        username = getIntent().getStringExtra("username");

        TextView titleNameBox = (TextView)findViewById(R.id.othertitleTextViewBox);
    ...
    public void onRentalClick(View v)
    {
        ...
        String other_title =toDisplay.getOtherType();
